		<div class="fl-col-flex2">
			<div class="fl-col">
				...
				<section class="idi-project fl-col-mixed">
					...
					<div class="fl-col-flex">
						<h3><a href="http://sites.google.com/site/decapodproject/">Decapod</a></h3>
			...
			<div class="fl-col">
				...
				<section class="idi-project fl-col-mixed">
					<div class="idi-project-logo fl-col-fixed fl-force-left">
						<a class="idi-no-tab-focus" href="http://zenit.senecac.on.ca/wiki/index.php/Big_Blue_Button">
							<img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/projects/Bigbluebutton.png" title="Big Blue Button logo" alt="Big Blue Button logo"/>
						</a>
					</div>
					<div class="fl-col-flex">
						<h3><a href="http://zenit.senecac.on.ca/wiki/index.php/Big_Blue_Button">Accessibility Features for Big Blue Button</a></h3>
