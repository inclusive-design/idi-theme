		<div class="fl-col-flex2">
			<div class="fl-col">
				<section class="idi-project fl-col-mixed">
					<div class="fl-col-fixed fl-force-left">
						<a class="idi-project-logo" href="http://floeproject.org"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/projects/floe-logo.png"/></a>
					</div>
				...
				<section class="idi-project fl-col-mixed">
					<div class="fl-col-fixed fl-force-left">
						<a class="idi-project-logo" href="http://gpii.net"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/projects/gpii_logo.png"/></a>
					</div>
					<div class="fl-col-flex">
			...
			<div class="fl-col">
				<section class="idi-project fl-col-mixed">
					<div class="fl-col-fixed fl-force-left">
						<a class="idi-project-logo" href="http://fluidproject.org"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/projects/fluid_logo.png"/></a>
					</div>
					<div class="fl-col-flex">
				...
				<section class="idi-project fl-col-mixed">
					<div class="fl-col-fixed fl-force-left">
						<a class="idi-project-logo" href="http://aegis.idrc.ocad.ca/"><img src="<?php bloginfo( 'stylesheet_directory' ); ?>/images/projects/aegis_logo.png"/></a>
					</div>
					<div class="fl-col-flex">
