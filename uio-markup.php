<script type="text/javascript">
    idi.setUpLoginOutPanel = function () {
        ...
        //Events              
        $('.idi-loginout').on('keypress mousedown', function() {	//Login/Logout button        
            <?php if ( is_user_logged_in() ): ?>					//Logging out, don't open panel (not working)               
                $(idi.selectors.loginForm).hide();
                $(idi.selectors.loginPanel).hide();                
            <?php else: ?>     
                $(idi.selectors.loginForm).show();					//Show login form
                $(".idi-logout").hide();
            <?php endif; ?>
        });                
    ...
    <div class="flc-uiOptions-fatPanel fl-uiOptions-fatPanel">        
        ...
        <div class="idi-slidingPanel-panel idi-loginOutPanel">
            ...
            <div class="idi-logout fl-text-align-center" style="display: none;">             
        ...
        <div class="fl-panelBar">
            ...
            <?php if ( is_user_logged_in() ): 
                ...
                <a href="<?php echo wp_logout_url(add_query_arg( 'idilogout', 'true', get_permalink())); ?>" class="fl-force-right"><button class="idi-slidingPanel-toggleButton fl-toggleButton idi-loginout">Login</button></a>                
